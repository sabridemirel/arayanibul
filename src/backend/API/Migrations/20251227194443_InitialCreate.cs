        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EnableOfferNotifications = table.Column<bool>(type: "boolean", nullable: false),
                    ...
                    VerificationBadges = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NeedImages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_NeedImages_Needs_NeedId",
                        column: x => x.NeedId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ThreeDSecureHtmlContent = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Transactions_AspNetUsers_ProviderId",
                        column: x => x.ProviderId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Messages_OfferId_CreatedAt",
                table: "Messages",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NeedImages_NeedId",
                table: "NeedImages",
                column: "NeedId");

            migrationBuilder.CreateIndex(
                name: "IX_Needs_CategoryId_Status_CreatedAt",
                table: "Needs",
                columns: new[] { "CategoryId", "Status", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_Needs_Location",
                table: "Needs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Offers_NeedId_Status",
                table: "Offers",
                columns: new[] { "NeedId", "Status" });
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "Reviews",
                columns: new[] { "RevieweeId", "IsVisible" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SearchHistories_SearchText_CreatedAt",
                table: "SearchHistories",
                columns: new[] { "SearchText", "CreatedAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_BuyerId_Status_CreatedAt",
                table: "Transactions",
                columns: new[] { "BuyerId", "Status", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_Transactions_ConversationId",
                table: "Transactions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_OfferId_Status",
                table: "Transactions",
                columns: new[] { "OfferId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_Transactions_ProviderId_Status_CreatedAt",
                table: "Transactions",
                columns: new[] { "ProviderId", "Status", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_UserBehaviors_TargetId_TargetType_CreatedAt",
                table: "UserBehaviors",
                columns: new[] { "TargetId", "TargetType", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_UserBehaviors_UserId_ActionType_CreatedAt",
                table: "UserBehaviors",
